...
public class SusheYuyueView extends SusheYuyueEntity implements Serializable {
	...
	*/
	...
	private String susheYuyueYesnoValue;
	...
	public SusheYuyueView() {

	}

	public SusheYuyueView(SusheYuyueEntity susheYuyueEntity) {
		try {
			BeanUtils.copyProperties(this, susheYuyueEntity);
	...
	* 获取： 申请状态的值
	*/
	public String getSusheYuyueYesnoValue() {
		return susheYuyueYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setSusheYuyueYesnoValue(String susheYuyueYesnoValue) {
		this.susheYuyueYesnoValue = susheYuyueYesnoValue;
	}
	...
	public String toString() {
		return "SusheYuyueView{" +
			", susheYuyueYesnoValue=" + susheYuyueYesnoValue +
			", susheName=" + susheName +
