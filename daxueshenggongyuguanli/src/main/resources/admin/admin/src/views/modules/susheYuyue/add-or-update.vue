    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="申请编号" prop="susheYuyueUuidNumber">
                       <el-input v-model="ruleForm.susheYuyueUuidNumber"
                                 placeholder="申请编号" clearable  :readonly="ro.susheYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="申请编号" prop="susheYuyueUuidNumber">
                           <el-input v-model="ruleForm.susheYuyueUuidNumber"
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="申请理由" prop="susheYuyueText">
                        <el-input type="textarea"  :readonly="ro.susheYuyueText" v-model="ruleForm.susheYuyueText" placeholder="申请理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.susheYuyueText" label="申请理由" prop="susheYuyueText">
                            <span v-html="ruleForm.susheYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.susheYuyueYesnoTypes" label="申请状态" prop="susheYuyueYesnoTypes">
                        <el-input v-model="ruleForm.susheYuyueYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.susheYuyueYesnoText" label="审核回复" prop="susheYuyueYesnoText">
                        <span v-html="ruleForm.susheYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.susheYuyueShenheTime" label="审核时间" prop="susheYuyueShenheTime">
                        <span v-html="ruleForm.susheYuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                xueshengForm: {},
                ro:{
                    susheYuyueUuidNumber: false,
                    susheId: false,
                    xueshengId: false,
                    susheYuyueText: false,
                    insertTime: false,
                    susheYuyueYesnoTypes: false,
                    susheYuyueYesnoText: false,
                    susheYuyueShenheTime: false,
                },
                ruleForm: {
                    ...
                    susheYuyueText: '',
                    insertTime: '',
                    susheYuyueYesnoTypes: '',
                    susheYuyueYesnoText: '',
                    susheYuyueShenheTime: '',
                },
                susheYuyueYesnoTypesOptions : [],
                susheOptions : [],
                xueshengOptions : [],
                rules: {
                   susheYuyueUuidNumber: [
                   ...
                   insertTime: [
                              { required: true, message: '宿舍申请时间不能为空', trigger: 'blur' },
                          ],
                   susheYuyueYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=sushe_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.susheYuyueYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`susheYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.susheYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
