<template>
    <div class="addEdit-block">
        <el-form
                ...
                >
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='sushe' && sessionTable !='suguan'">
                ...
                <el-col :span="12"  v-if="sessionTable !='sushe' ">
                    <el-form-item class="input" v-if="type!='info'"  label="楼宇" prop="danyuanValue">
                        <el-input v-model="susheForm.danyuanValue"
                                  placeholder="楼宇" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="楼宇" prop="danyuanValue">
                            <el-input v-model="ruleForm.danyuanValue"
                                      placeholder="楼宇" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='sushe' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='xuesheng' && sessionTable !='suguan'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="投诉编号" prop="susheTousuUuidNumber">
                       <el-input v-model="ruleForm.susheTousuUuidNumber"
                                 placeholder="投诉编号" clearable  :readonly="ro.susheTousuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="投诉编号" prop="susheTousuUuidNumber">
                           <el-input v-model="ruleForm.susheTousuUuidNumber"
            ...
            <input id="susheId" name="susheId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="投诉事由" prop="susheTousuText">
                        <el-input type="textarea"  :readonly="ro.susheTousuText" v-model="ruleForm.susheTousuText" placeholder="投诉事由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.susheTousuText" label="投诉事由" prop="susheTousuText">
                            <span v-html="ruleForm.susheTousuText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="投诉类型" prop="susheTousuTypes">
                        <el-select v-model="ruleForm.susheTousuTypes" :disabled="ro.susheTousuTypes" placeholder="请选择投诉类型">
                            <el-option
                                v-for="(item,index) in susheTousuTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="投诉类型" prop="susheTousuValue">
                        <el-input v-model="ruleForm.susheTousuValue"
                            placeholder="投诉类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info' && sessionTable !='suguan'"  label="投诉状态" prop="susheTousuZhuangtaiTypes">
                        <el-select v-model="ruleForm.susheTousuZhuangtaiTypes" :disabled="ro.susheTousuZhuangtaiTypes" placeholder="请选择投诉状态">
                            <el-option
                                v-for="(item,index) in susheTousuZhuangtaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="投诉状态" prop="susheTousuZhuangtaiValue">
                        <el-input v-model="ruleForm.susheTousuZhuangtaiValue"
                            placeholder="投诉状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="投诉回复" prop="xueshengKaoqinContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xueshengKaoqinContent" label="投诉回复" prop="xueshengKaoqinContent">
    ...
    export default {
        data() {
            return {
                ...
                xueshengForm: {},
                ro:{
                    susheTousuUuidNumber: false,
                    xueshengId: false,
                    susheId: false,
                    susheTousuText: false,
                    insertTime: false,
                    susheTousuTypes: false,
                    susheTousuZhuangtaiTypes: false,
                    xueshengKaoqinContent: false,
                },
                ruleForm: {
                    susheTousuUuidNumber: new Date().getTime(),
                    xueshengId: '',
                    susheId: '',
                    susheTousuText: '',
                    insertTime: '',
                    susheTousuTypes: '',
                    susheTousuZhuangtaiTypes: '',
                    xueshengKaoqinContent: '',
                },
                susheTousuTypesOptions : [],
                susheTousuZhuangtaiTypesOptions : [],
                susheOptions : [],
                xueshengOptions : [],
                rules: {
                   susheTousuUuidNumber: [
                   ...
                   xueshengKaoqinContent: [
                              { required: true, message: '投诉回复不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=sushe_tousu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.susheTousuTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=sushe_tousu_zhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.susheTousuZhuangtaiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.xueshengKaoqinContent = _this.ruleForm.xueshengKaoqinContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.xueshengKaoqinContent = this.ruleForm.xueshengKaoqinContent.replaceAll(this.$base.url,"");
                        this.$http({
