...
public class SusheTuisuView extends SusheTuisuEntity implements Serializable {
	...
	*/
	...
	private String susheTuisuYesnoValue;
	...
	//级联表 宿舍
		...
		* 楼宇
		*/
		@ColumnInfo(comment="楼宇",type="int(11)")
		private Integer danyuanTypes;
			/**
			* 楼宇的值
			*/
			@ColumnInfo(comment="楼宇的字典表值",type="varchar(200)")
	...
	public SusheTuisuView() {

	}

	public SusheTuisuView(SusheTuisuEntity susheTuisuEntity) {
		try {
			BeanUtils.copyProperties(this, susheTuisuEntity);
	...
	* 获取： 申请状态的值
	*/
	public String getSusheTuisuYesnoValue() {
		return susheTuisuYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setSusheTuisuYesnoValue(String susheTuisuYesnoValue) {
		this.susheTuisuYesnoValue = susheTuisuYesnoValue;
	}
	...
	public String toString() {
		return "SusheTuisuView{" +
			", susheTuisuYesnoValue=" + susheTuisuYesnoValue +
			", susheName=" + susheName +
